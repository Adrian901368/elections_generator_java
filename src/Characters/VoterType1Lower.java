...
/**
 * Trieda predstavujuca volica typu 1 s nizzsim socialnym statusom.
 */
public class VoterType1Lower extends VoterType1 {

    /**
     * Konstruktor pre vytvorenie volica typu 1 s nizsim socialnym statusom s nahodnymi udajmi.
     */
    public VoterType1Lower() {
    ...
    public Candidate vote(List<Candidate> candidates) {
        // Vyberieme kandidatov, ktori maju aspon jeden prijatlny slub pre volica typu 1
        ...
        if (eligibleCandidates.isEmpty()) {
            return null; // ziadni vhodní kandidati
        }
    ...
    /**
     *Overi, ci je kandidat vhodny na zaklade prijatych slubov volica typu 1 s vyssim socialnym statusom.
