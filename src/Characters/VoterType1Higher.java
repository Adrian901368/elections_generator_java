...
/**
 * Trieda predstavujuca volica typu 1 s vyssim socialnym statusom.
 */
public class VoterType1Higher extends VoterType1 {

    /**
     * Konstruktor pre vytvorenie volica typu 1 s vyssim socialnym statusom s nahodnymi udajmi.
     */
    public VoterType1Higher() {
    ...
    public Candidate vote(List<Candidate> candidates) {
        // Vyberieme kandidatov, ktorí maju aspon jeden prijatelný slub pre volica typu 1
