...
/**
 * Trieda predstavujuca volica typu 3 s nizsim socialnym statusom.
 */
public class VoterType3Lower extends VoterType3 {

    /**
     * Konatruktor pre vytvorenie volica typu 3 s nizsim socialnym statusom s nahodnymi udajmi.
     */
    public VoterType3Lower() {
    ...
    public Candidate vote(List<Candidate> candidates) {
        // Vyberieme kandidatov, ktori maji aspon jeden prijatelny slub pre volica typu 1
    ...
    /**
     * Overi, ci je kandidat vhodny na zaklade prijatych slubov volica typu 3 s nizsim socialnym statusom.
