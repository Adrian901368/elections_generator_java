...
/**
 * Trieda predstavujuca voliča typu 2 s vyssím socialnym statusom.
 */
public class VoterType2Higher extends VoterType2 {

    /**
     * Konstruktor pre vytvorenie volica typu 2 s vyssim socialnym statusom s nahodnymi udajmi.
     */
    public VoterType2Higher() {
    ...
    /**
     * Hlasuje za kandidata zo zoznamu kandidatov na zaklade prijatych sľubov a zvysuje pocet hlasov vybraneho kandidata o 1.
    ...
    public Candidate vote(List<Candidate> candidates) {
        ...
        if (eligibleCandidates.isEmpty()) {
            return null; // Ziadni vhodni kandidati
        }

        // Nahodny vyber z vhodnych kandidatov
        Candidate chosenCandidate = eligibleCandidates.get(new Random().nextInt(eligibleCandidates.size()));
        // Zvysime pocet hlasov vybraneho kandidata o 1
        chosenCandidate.increaseVote(this);
        return chosenCandidate;
    }

    /**
     * Overi, či je kandidat vhodny na zaklade prijatych slubov volica typu 2 s vyssim socialnym statusom.
